...
ENV QWEN3_VL_EMBEDDING_BASE_URL=http://127.0.0.1:30049/v1
ENV QWEN3_VL_EMBEDDING_MODEL_NAME=Qwen3-VL-Embedding-8B
ENV QWEN3_VL_EMBEDDING_DIM=4096
ENV EMBEDDING_MODEL=qwen3-vl
ENV MILVUS_VIDEO_COLLECTION_NAME=video_vector_qwen3vl8b_4096
ENV MILVUS_VIDEO_FRAME_COLLECTION_NAME=video_frame_vector_qwen3vl8b_4096
ENV MILVUS_VIDEO_TEXT_FEATURE_COLLECTION_NAME=video_text_features_qwen3vl8b_4096
ENV MILVUS_VIDEO_VISUAL_FEATURE_COLLECTION_NAME=video_visual_features_qwen3vl8b_4096
